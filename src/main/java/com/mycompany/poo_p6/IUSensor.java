 ...
 * @author Computacion
 */
public class IUSensor extends JFrame{
    private String filename;
    private Sensor sensor;
    private Image imagen;
    private int posX = 430,posY = 190,width = 200,height = 200;

    public IUSensor(String filename, Sensor sensor) throws IOException {
